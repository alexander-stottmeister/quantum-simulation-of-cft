...
\bibitem [{\citenamefont {Osborne}\ and\ \citenamefont
  ...
  comparison}},\ }\bibinfo {note} {source repository
  \url{https://github.com/alexander-stottmeister/lattice_cft} (July 2026;
  theorem numbers below refer to \texttt{free\_fermion\_cft\_v5})}\ (\bibinfo
